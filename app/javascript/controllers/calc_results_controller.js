...
// Connects to data-controller="calc-results"
export default class extends Controller {
  ...
  removeOldTable() {
    let calcResultsTbody = this.calcResultsTbodyTarget;
    while (calcResultsTbody.firstChild) {
      calcResultsTbody.removeChild(calcResultsTbody.firstChild);
    }
  }
}
